...
namespace CivicHub.Application.IntegrationTests.Features.Persons.Queries.SimpleSearchPerson;

public class SimpleSearchPersonQueryHandlerTests : IntegrationTestBase
{
    ...
    public async Task When_MatchingPersonInfoIsPassed_Then_ReturnFoundPerson()
    {
        ...
        var query = new SimpleSearchPersonQuery(
            PageSize,
            PageNumber,
